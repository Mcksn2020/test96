...
#точки по оси У
y0=str(50+(100*(f_curr-op_str)/y_m-100*op_prc/y_m))
y1=str(50-100*op_prc/y_m)
y2=y1
y3=str(50+(100*(x_end-op_str)/y_m-100*op_prc/y_m))
#прямая начинается в точке op_str и имеет смещение op_prc с минусом в случае покупки
