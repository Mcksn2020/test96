...
g_chd='chd=t:'+point_calc.x1+','+point_calc.x2+','+point_calc.x3+'|33,66,99|0,100|50,50'
#g_chs1='chs=250x100'
#g_chs2='chs=250x250'
g_chs='chs=400x400'            #   размер
g_chl='chl=ОПЦИОНЫ'                 # название
g_chc='chco=00FF00,FF0000'              # цвет линии
...
g_chxr='chxr=0,'+x_ii+','+x_ee+','+str(point_calc.x_st)+'|1,-200,200'



gc=gc+g_cht+'&'+g_chd+'&'+g_chs+'&'+g_chc+'&'+g_chttl+'&'+g_chtts
gc=gc+'&'+g_chxt+'&'+g_grid+'&'+ g_chxr
